...
export const nightForest: SceneConfig = {
  ...
  layers:[{id:'background',src:assetUrl('assets/scenes/night-reference.webp'),depth:12},{id:'midground',src:assetUrl('assets/scenes/mist.webp'),depth:26},{id:'foreground',src:assetUrl('assets/scenes/leaves-reference.webp'),depth:44}],
