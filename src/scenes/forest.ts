...
export const forest: SceneConfig = {
  ...
  interactions:{mushroom:{src:assetUrl('assets/scenes/mushrooms.webp'),x:32,y:82,mobileX:20,mobileY:81,size:112,mobileSize:88,depth:34},water:{top:86,height:14,mobileTop:86,mobileHeight:14,depth:12}},
  reactions:{lightOn:'lookUp',mushroom:'listen',water:'listen'},
  layers:[{id:'background',src:assetUrl('assets/scenes/forest-reference.webp'),depth:12},{id:'midground',src:assetUrl('assets/scenes/mist.webp'),depth:26},{id:'foreground',src:assetUrl('assets/scenes/leaves-reference.webp'),depth:44}],
